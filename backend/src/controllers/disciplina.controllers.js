...
const createDisciplina = async(req, res, next) => {
    ...
    try {
        ...
        const nuevaDisciplina = await pool.query(
            "INSERT INTO Disciplina (cod, nombre, descripcion, precio, activo) VALUES ($1, $2, $3, $4, $5) RETURNING cod", [cod, nombre, descripcion, precio, activo]
        );
...
const updateDisciplina = async(req, res, next) => {
    try {
        ...
        const result = await pool.query(
            "UPDATE Disciplina SET NOMBRE = $1, DESCRIPCION = $2, PRECIO = $3,ACTIVO=$4 WHERE cod = $5 RETURNING *", [nombre, descripcion, precio, activo, cod]
        );
