...
export const createCategoriaRequest = async (categoria) => axios.post("/categorias", categoria);
...
export const deleteCategoriaRequest = async (id) => axios.delete(`/categorias/${id}`);
