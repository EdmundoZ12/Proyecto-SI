...
export default function ProductoComponent() {
  ...
  const onInputChange = (e, name) => {
    ...
    let _product = { ...entrada };
    _product[`${name}`] = val;  // Usar solo val, ya que ya contiene el valor deseado
    setEntrada(_product);
  };
      ...
      >
            ...
            {proveedores.map((proveedor) => (
              <div className="field-radiobutton col-6" key={proveedor.id}>
                <RadioButton
                  ...
                  checked={entrada.id === proveedor.id}
                />
        ...
        >
          ...
          <div className="field col" style={{ marginTop: "24px" }}>
            <Button icon="pi pi-plus" aria-label="Filter" onClick={agregarProducto} />
          </div>
        </div>
