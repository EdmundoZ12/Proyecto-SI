...
export default function MembresiaComponent() {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
          try {
            const response = await fetch('http://localhost:3000/cliente/index');
            if (response.ok) {
    ...
    useEffect(() => {
        ...
        fetch('http://localhost:3000/membresia/index')
    ...
    const saveProduct = () => {
        ...
        const fechaNueva = sumar30Dias(product.fechaI);
                ...
                fetch('http://localhost:3000/membresia/create', {
                    method: 'POST',
                    headers: {
    ...
    const editProduct = (product) => {
        fetch('http://localhost:3000/membresia/get/'+product.id_cliente)
