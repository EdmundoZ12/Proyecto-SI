...
export default function Nota_EntradasDemo() {
  ...
  const agregarProducto = () => {
    const nuevoProducto = {
      cod: entrada.cod_producto, // Cambiar a la propiedad correcta para el código del producto
      empresa: product.empresa, // Cambiar a la propiedad correcta para el nombre del producto
      cantidad: entrada.cantidad,
      precio:parseFloat(entrada.precio)
    };
    console.log(product.empresa);
  ...
  const onCategoryChange = async (e) => {
    ...
    const nombreprov = await getProveedor(e.value);

    _product["id_proveedor"] = e.value;

    console.log(nombreprov.empresa);

    _product["empresa"] = nombreprov.empresa;
    setProduct(_product);
  };
      ...
      >
        ...
        <div className="field">
          ...
          <Dropdown
            ...
            onChange={(e) => onInputNumberChange(e, "cod_producto")} // Actualiza el campo "id_rol"
